 ...
 */
 ...
 #define RQ_SET_PTT_LED			4
 #define RQ_SET_STATUS_LED		5
 #define RQ_SET_POWER_LED		6
 #define RQ_GET_POTI_CHANNEL	7
 #define RQ_GET_POTI_CHANNEL1	8
 #define RQ_GET_POTI_CHANNEL2	9
